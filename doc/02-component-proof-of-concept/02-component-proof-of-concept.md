...
I'm choosing my HexColor component design because it is the most feasible and the least vague. My AttendanceTracker idea is alright, but it a: I'm tired of attendance trackers (I have done a website version to fulfill my my attendance tracking needs) and it just doesn't interest me as much anymore. Meanwhile, Door might be a little too complicated, as well as my original set of Kernel methods was very extensive. The Door design might be something for later. I do think the HexColor design is the most specific, feasible, and the least boring.
